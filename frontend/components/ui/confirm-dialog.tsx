      ...
      <Dialog.Portal>
        ...
        <Dialog.Popup
          ...
          className={cn(
            ...
            "transition-[transform,opacity] duration-[260ms] ease-[cubic-bezier(0.16,1,0.3,1)]",
            "data-[starting-style]:translate-y-2 data-[starting-style]:scale-95 data-[starting-style]:opacity-0",
            "data-[ending-style]:translate-y-2 data-[ending-style]:scale-95 data-[ending-style]:opacity-0 data-[ending-style]:duration-[160ms] data-[ending-style]:ease-[cubic-bezier(0.4,0,1,1)]"
          )}
        >
